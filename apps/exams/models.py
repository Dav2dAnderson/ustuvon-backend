...
class Examination(models.Model):
    ...
    duration_time = models.PositiveIntegerField(default=timedelta(minutes=120))
    ...
    def __str__(self):
        return f"title {self.title}, ({self.duration_time} min)"
...
class Result(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.is_passed = self.score >= self.exam.transition_assesment
